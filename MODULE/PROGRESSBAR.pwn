...
stock ShowProgressBar(playerid, text[] = "", Times)
{
    if(ProgressBar[playerid] == 1) return SCM(playerid, COLOR_RED, "ERROR: "W"Sedang ada progressbar sedang berjalan");

	new Float:Value = LoadingPlayerBar[playerid]*101/100;
	new Timeron = Times*1000/100;
	
    ProgressBar[playerid] = 1;
...
stock HideProgressBar(playerid)
{
...
stock CreatePlayerTdProgressBar(playerid)
{
    PROGRESSBAR[playerid][0] = CreatePlayerTextDraw(playerid, 270.000000, 364.000000, "ld_bum:blkdot");
	...
	PROGRESSBAR[playerid][1] = CreatePlayerTextDraw(playerid, 270.000000, 364.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawColor(playerid, PROGRESSBAR[playerid][1], hud_green);
	...
	PROGRESSBAR[playerid][2] = CreatePlayerTextDraw(playerid, 320.000000, 370.000000, "Loading..");
	...
	PROGRESSBAR[playerid][3] = CreatePlayerTextDraw(playerid, 270.000000, 363.000000, "ld_bum:blkdot");
	...
	PROGRESSBAR[playerid][4] = CreatePlayerTextDraw(playerid, 269.000000, 363.000000, "ld_bum:blkdot");
	...
	PROGRESSBAR[playerid][5] = CreatePlayerTextDraw(playerid, 269.000000, 387.000000, "ld_bum:blkdot");
	...
	PROGRESSBAR[playerid][6] = CreatePlayerTextDraw(playerid, 371.000000, 363.000000, "ld_bum:blkdot");
...
{
   	if(ProgressBar[playerid] == 1) return 1;
	ShowProgressBar(playerid, "Loading..", 10);
	return 1;
}
